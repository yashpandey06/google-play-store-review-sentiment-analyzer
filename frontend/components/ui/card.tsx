  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[.border-b]:pb-6 [.border-b]:border-b",
        className
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "leading-tight font-semibold text-xl tracking-tight", 
        "text-foreground/90",
        className
      )}
      {...props}
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "px-6 text-sm text-card-foreground/90 leading-relaxed",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center px-6 gap-4 mt-2",
        "[.border-t]:pt-6 [.border-t]:border-t [.border-t]:border-border/50",
        className
      )}
      {...props}
    />
